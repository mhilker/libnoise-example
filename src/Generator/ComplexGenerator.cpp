...
//    const int CUR_SEED = std::stoi(seed);
//
...
//    // Write the image as a Windows bitmap file (*.bmp).
//    bitmapWriter.SetSourceImage (destImage);
//    bitmapWriter.SetDestFilename (surfaceFilename.str());
//    bitmapWriter.WriteDestFile ();
//
//
//
...
//    bitmapWriter.SetSourceImage (destImage);
//    bitmapWriter.SetDestFilename (specularFilename.str());
//    bitmapWriter.WriteDestFile ();
//
//
//
...
//    bitmapWriter.SetSourceImage (destImage);
//    bitmapWriter.SetDestFilename (normalFilename.str());
//    bitmapWriter.WriteDestFile ();
}
